...
const { OlandUnitModule } = require('./OlandUnit');
...
function attachGeneratedModules(client, http) {
  ...
  client.biometric = client.biometric || new BiometricModule(http);
  ...
  client.oidc = client.oidc || new OidcModule(http);
  client.oLand = client.oLand || new OLandModule(http);
  client.olandUnit = client.olandUnit || new OlandUnitModule(http);
