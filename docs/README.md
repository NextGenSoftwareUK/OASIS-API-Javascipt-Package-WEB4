...
| [`oasis.data`](modules/Data.md) | `api/data` | 10 |
| [`oasis.eOSIO`](modules/EOSIO.md) | `api/eosio` | 9 |
| [`oasis.eggs`](modules/Eggs.md) | `api/eggs` | 6 |
| [`oasis.files`](modules/Files.md) | `api/files` | 6 |
...
| [`oasis.stats`](modules/Stats.md) | `api/stats` | 8 |
| [`oasis.subscription`](modules/Subscription.md) | `api/subscription` | 10 |
| [`oasis.video`](modules/Video.md) | `api/video` | 3 |
| [`oasis.wallet`](modules/Wallet.md) | `api/wallet` | 32 |
