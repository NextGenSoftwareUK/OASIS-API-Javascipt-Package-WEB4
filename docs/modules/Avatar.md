...
`result` type: `NextGenSoftware.OASIS.API.Core.Objects.Avatar.AvatarSession` _(type definition not found - field list unavailable)_
...
```json
{
  "isError": false,
  "message": "",
  "result": /* <NextGenSoftware.OASIS.API.Core.Objects.Avatar.AvatarSession> */
}
```
...
`result` type: `IEnumerable<IAvatar>` (array)
...
`result` type: `IEnumerable<IAvatarDetail>` (array)
...
`result` type: `Dictionary<string, List<string>>` _(type definition not found - field list unavailable)_
...
`result` type: `NextGenSoftware.OASIS.API.Core.Objects.Avatar.AvatarSessionStats` _(type definition not found - field list unavailable)_
...
```json
{
  "isError": false,
  "message": "",
  "result": /* <NextGenSoftware.OASIS.API.Core.Objects.Avatar.AvatarSessionStats> */
}
```
...
`result` type: `NextGenSoftware.OASIS.API.Core.Objects.Avatar.AvatarSessionManagement` _(type definition not found - field list unavailable)_
...
```json
{
  "isError": false,
  "message": "",
  "result": /* <NextGenSoftware.OASIS.API.Core.Objects.Avatar.AvatarSessionManagement> */
}
```
...
const { isError, message, result } = await oasis.avatar.updateAvatarDetail({
    ...
    gifts: [{ "AvatarId": "3fa85f64-5717-4562-b3fc-2c963f66afa6", "GiftEarnt": "2026-01-01T00:00:00Z", "GiftType": /* <KarmaTypePositive> */, "KarmaSource": /* <EnumValue<KarmaSourceType>> */, "KarmaSourceDesc": "example string", "KarmaSourceTitle": "example string", "Provider": /* <EnumValue<ProviderType>> */, "WebLink": "example string" }],
    chakras: [{ "Name": "example string", "SanskritName": "example string", "Description": "example string", "WhatItControls": "example string", "YogaPose": /* <EnumValue<YogaPoseType>> */, "WhenItDevelops": "example string", "Element": /* <EnumValue<ElementType>> */, "Crystal": { "Name": /* <EnumValue<CrystalName>> */, "Type": /* <EnumValue<CrystalType>> */, "Description": "example string", "ProtectionLevel": 1, "EnergisingLevel": 1, "GroundingLevel": 1, "CleansingLevel": 1, "AmplifyicationLevel": 1 }, "Color": { "Default": /* <static Color> */, "R": 1, "G": 1, "B": 1, "Number": /* <internal byte> */, "IsDefault": /* <internal bool> */ }, "Level": 1, "Progress": 1, "XP": 1, "Type": /* <EnumValue<ChakraType>> */, "GiftsUnlocked": [{ "AvatarId": "3fa85f64-5717-4562-b3fc-2c963f66afa6", "GiftType": /* <KarmaTypePositive> */, "GiftEarnt": "2026-01-01T00:00:00Z", "KarmaSourceTitle": "example string", "KarmaSourceDesc": "example string", "WebLink": "example string", "KarmaSource": /* <EnumValue<KarmaSourceType>> */, "Provider": /* <EnumValue<ProviderType>> */ }] }],
    dimensionLevelIds: /* <IDictionary<DimensionLevel, Guid>> */,
    dimensionLevels: /* <IDictionary<DimensionLevel, IHolon>> */,
    ...
    achievements: [{ "AchievementEarnt": "2026-01-01T00:00:00Z", "AchievementType": /* <KarmaTypePositive> */, "AvatarId": "3fa85f64-5717-4562-b3fc-2c963f66afa6", "Description": "example string", "KarmaSource": /* <EnumValue<KarmaSourceType>> */, "KarmaSourceDesc": "example string", "KarmaSourceTitle": "example string", "Name": "example string", "Provider": /* <EnumValue<ProviderType>> */, "WebLink": "example string" }],
    inventory: [{ "Image2D": "<base64-bytes>", "Image2DURI": "https://example.com/asset.png", "ThumbnailUrl": "example string", "Object3D": "<base64-bytes>", "Object3DURI": "https://example.com/asset.png", "Quantity": 1, "Stack": true, "IsStackable": true, "GameSource": "example string", "ItemType": "example string", "NftId": "example string", "Rarity": "example string", "MaxQuantity": 1, "Weight": 1.0, "IsUsable": true, "IsTradeable": true, "OwnerAvatarId": "example string", "AcquiredOn": "2026-01-01T00:00:00Z", "LastUsedOn": "2026-01-01T00:00:00Z", "Properties": /* <Dictionary<string, object>> */ }],
    activeQuestId: "3fa85f64-5717-4562-b3fc-2c963f66afa6",
    activeObjectiveId: "3fa85f64-5717-4562-b3fc-2c963f66afa6",
    karmaAkashicRecords: [{ "AvatarId": "3fa85f64-5717-4562-b3fc-2c963f66afa6", "Date": "2026-01-01T00:00:00Z", "Karma": 1, "KarmaEarntOrLost": /* <EnumValue<KarmaEarntOrLost>> */, "KarmaSource": /* <EnumValue<KarmaSourceType>> */, "KarmaSourceDesc": "example string", "KarmaSourceTitle": "example string", "KarmaTypeNegative": /* <EnumValue<KarmaTypeNegative>> */, "KarmaTypePositive": /* <EnumValue<KarmaTypePositive>> */, "Provider": /* <EnumValue<ProviderType>> */, "TotalKarma": 1, "WebLink": "example string" }]
  });
if (isError) throw new Error(message);
console.log(result);
```
