...
// Hand-written Auth module declaration (the one non-generated module).
fs.writeFileSync(
  path.join(modulesDir, 'Auth.d.ts'),
...
// Top-level index.d.ts wiring every module onto OASISClient.
